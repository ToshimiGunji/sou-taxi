...
class TestFromrecords:
    ...
    def test_recarray_fromarrays(self):
        ...
        x1[1] = 34
        assert_equal(r.finish_signal, np.array([1, 2, 3, 4]))
    ...
    def test_recarray_views(self):
        ...
        assert_equal(r.finish_signal.dtype.type, np.record)
    ...
    def test_fromrecords_with_explicit_dtype(self):
        ...
        assert_equal(a.finish_signal, [1, 2])
        assert_equal(a[0].finish_signal, 1)
